...
public class ChangeStartTime_Transaction implements jTPS_Transaction {
    ...
    public ChangeStartTime_Transaction(int newTime, int oldTime, ArrayList<TimeSlot> officeHours, CSGData data, CSGWorkspace workspace) {
    ...
    public void doTransaction() {
        ...
        workspace.getTATab().getStartComboBox().setValue(newTime + ":00");
    }
    ...
    public void undoTransaction() {
        ...
        workspace.getTATab().getStartComboBox().setValue(oldTime + ":00");
    }
