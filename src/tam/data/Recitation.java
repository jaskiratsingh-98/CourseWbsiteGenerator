...
public class Recitation<E extends Comparable<E>> implements Comparable<E> {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CourseInfo)) {
            ...
            Recitation ra = (Recitation) other;
            return section.get().equals(ra.section.get())
                    && instructor.get().equals(ra.instructor.get())
                    && dayTime.get().equals(ra.dayTime.get())
                    && location.get().equals(ra.location.get())
                    && ta1.get().equals(ra.ta1.get())
                    && ta2.get().equals(ra.ta2.get());
        }
